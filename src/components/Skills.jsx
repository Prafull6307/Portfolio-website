  ...
  return (
    <>
      <div className="bg-yellow-200 py-6 md:py-12">
        ...
        <h1 className="text-center font-bold text-3xl md:text-4xl lg:text-5xl underline mt-3 mb-6 md:mb-10">Skills</h1>
        ...
        <div className="flex flex-col md:flex-row justify-center">
          <div className="w-full md:w-5/12 lg:w-1/2 my-4 mx-2 bg-black rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <div className="flex flex-wrap justify-center space-x-8 py-3 hover:bg-yellow-300 rounded-lg">
